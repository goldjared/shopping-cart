  ...
  return (
    <>
      <div className="page-text">
        ...
        <p>
          Welcome to my fake shopping cart. The purpose of this project was my
          practice of React,{" "}
          <strong>
            click the <Link to={`/shop`}>shop</Link> link to leave this page.
          </strong>{" "}
          <br></br>Fugiat tempora fuga consequuntur ullam obcaecati dolorem nam
      ...
      <a
        id="photo-credit"
        href="https://www.pexels.com/photo/art-abstract-moon-design-18423422/"
      >
